...
# Guerilla Publishing Toolbox {anchor=false}
Designing workflows for alternative publishing

{{<button href="/docs/">}}Open Toolbox{{</button>}}

</div>

{{% columns %}}
- ## Altered State Publishing
...
## Email us with question or suggestions

{{% columns %}}
- **Mackenzie Salisbury**  
Curriculum Innovation Librarian  
Northwestern University Libraries  
msalisbury@northwestern.edu  
